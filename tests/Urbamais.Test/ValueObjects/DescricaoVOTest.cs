...
{ 
    ...
    {
        var descricao = new Descricao("Descricao correta");
    ...
    {
        var Descricao1 = new Descricao("Wesley Santana");
        var Descricao2 = new Descricao("Wesley Santana");
    ...
    {
        var Descricao1 = new Descricao("Wesley Santana");
        var Descricao2 = new Descricao("Rita Santana");
