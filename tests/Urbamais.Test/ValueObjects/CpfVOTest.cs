...
public class CpfVOTest
{
    ...
    {
        var Cpf = new Cpf("451.254.470-48");
    ...
    {
        var cpf = new Cpf("451.254.470-47");

        Assert.False(cpf.IsValid);

        var msg = $"The specified condition was not met for '{nameof(cpf.Value)}'.";
    ...
    public void CpfTamanhoMenor()
    {
        ...
        var msg = $"'{nameof(cpf.Value)}' must be 11 characters in length. You entered {valor.Length} characters.";
        Assert.Contains(cpf.ValidationResult!.Errors, x => x.ErrorMessage.Equals(msg));
    }
    ...
    public void CpfVazio()
    {
        ...
        var msg = $"'{nameof(cpf.Value)}' must be 11 characters in length. You entered 0 characters.";
        Assert.Contains(cpf.ValidationResult!.Errors, x => x.ErrorMessage.Equals(msg));
    }
    ...
    {
        var cpf1 = new Cpf("451.254.470-48");
        var cpf2 = new Cpf("451.254.470-48");
    ...
    {
        var cpf1 = new Cpf("451.254.470-48");
        var cpf2 = new Cpf("044.194.180-01");
