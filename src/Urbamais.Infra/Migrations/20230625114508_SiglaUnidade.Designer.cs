...
namespace Urbamais.Infra.Migrations
{
    ...
    [Migration("20230625114508_SiglaUnidade")]
    partial class SiglaUnidade
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.ValueObjects.ArquivoVO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Urbamais.Domain.Entities.Fornecedor.Colaborador", b =>
                {
                    ...
                    b.Property<Guid>("CarteiraTrabalhoId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("ExameAdmissionalId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("FichaEPIId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("FichaRegistroId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ExameAdmissionalId");

                    b.HasIndex("FichaEPIId");

                    b.HasIndex("FichaRegistroId");
            ...
            modelBuilder.Entity("Urbamais.Domain.Entities.Fornecedor.Colaborador", b =>
                {
                    b.HasOne("Core.ValueObjects.ArquivoVO", "CNH")
                        .WithMany()
                        .HasForeignKey("CNHId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.ValueObjects.ArquivoVO", "CarteiraTrabalho")
                        .WithMany()
                        .HasForeignKey("CarteiraTrabalhoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.ValueObjects.ArquivoVO", "ExameAdmissional")
                        .WithMany()
                        .HasForeignKey("ExameAdmissionalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.ValueObjects.ArquivoVO", "FichaEPI")
                        .WithMany()
                        .HasForeignKey("FichaEPIId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.ValueObjects.ArquivoVO", "FichaRegistro")
                        .WithMany()
                        .HasForeignKey("FichaRegistroId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.ValueObjects.ArquivoVO", "OrdemServico")
                        .WithMany()
                    ...
                    b.Navigation("ExameAdmissional");

                    b.Navigation("FichaEPI");

                    b.Navigation("FichaRegistro");
